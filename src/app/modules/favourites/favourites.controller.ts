...
const addFavourite = catchAsync(async (req: any, res: Response) => {
...
const removeFavourite = catchAsync(async (req: any, res: Response) => {
...
const getPatientFavourites = catchAsync(async (req: any, res: Response) => {
